...
<template>
    <Teleport to="body">
        <div v-if="modelValue" class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <!-- Backdrop -->
            <div class="fixed inset-0 bg-black/50 transition-opacity backdrop-blur-sm" @click="close"></div>
            ...
            <div :class="cn(
                ...
                <div class="flex items-start justify-between px-6 py-4 border-b border-border">
                    <div>
                        <h2 v-if="title" class="text-xl font-bold text-foreground overflow-hidden text-ellipsis">{{
                            title
                        }}</h2>
