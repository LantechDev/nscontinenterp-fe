...
<template>
  <div
    ...
    "
  >
    <div class="ebl-back-header text-center border-b border-[#062c58]">
      <h2 class="text-[15px] font-bold uppercase tracking-widest leading-tight">
        {{
          isAir
            ? "Air Waybill"
            : isTrucking
      ...
      <h3 class="mt-0.5 text-xs font-semibold uppercase leading-none">Conditions of Contract</h3>
    </div>

    <div class="ebl-back-clauses columns-2 text-justify flex-1 overflow-hidden">
      <div
        v-for="condition in activeConditions"
        :key="condition.id"
        class="ebl-back-clause break-inside-avoid"
      >
