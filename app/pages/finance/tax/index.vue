    ...
    <div class="space-y-6 animate-fade-in pb-10">
        ...
        <div class="flex items-center justify-between gap-4">
            <div class="relative w-full max-w-sm">
                ...
                <input type="text" placeholder="Cari pajak..."
            ...
            <div class="flex items-center gap-3">
                ...
                <NuxtLink to="/finance/tax/create"
        ...
        <div v-if="viewMode === 'list'" class="border border-border rounded-xl bg-white overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody>
                        <tr v-for="tax in taxRecords" :key="tax.id"
                            ...
                            <td class="py-3 px-4 text-sm text-muted-foreground">{{ tax.period }}</td>
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div v-for="tax in taxRecords" :key="tax.id"
