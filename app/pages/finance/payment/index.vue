...
const payments = [
    { id: "1", number: "PAY-2024-001", invoice: "INV-2024-0891", customer: "CV Sukses Makmur", date: "6 Jan 2025", amount: "Rp 18.250.000", method: "Bank Transfer" },
    { id: "2", number: "PAY-2024-002", invoice: "INV-2024-0889", customer: "PT Indo Global", date: "5 Jan 2025", amount: "Rp 12.500.000", method: "Bank Transfer" },
];
    ...
    <div class="space-y-6 animate-fade-in pb-10">
        ...
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                <NuxtLink to="/finance/payment/create"
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <tr v-for="payment in payments" :key="payment.id"
                            ...
                            <td class="py-3 px-4 text-sm text-muted-foreground">{{ payment.invoice }}</td>
                            <td class="py-3 px-4 text-sm">{{ payment.customer }}</td>
                            <td class="py-3 px-4 text-sm text-muted-foreground">{{ payment.date }}</td>
                            <td class="py-3 px-4 text-sm font-medium text-success">{{ payment.amount }}</td>
                            <td class="py-3 px-4 text-sm text-muted-foreground">{{ payment.method }}</td>
            ...
            <div v-for="payment in payments" :key="payment.id"
                ...
                <div class="flex items-start justify-between mb-4">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="font-bold text-base text-foreground">{{ payment.number }}</h3>
