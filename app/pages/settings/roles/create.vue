            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1 md:col-span-2 pt-4 border-t border-border">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button type="button" @click="addPermissionRow" class="text-xs btn-secondary px-3 py-1 h-8">
                    ...
                    <div class="space-y-3 bg-muted/30 p-4 rounded-lg">
                        ...
                        <p v-if="permissionList.length === 0" class="text-sm text-muted-foreground text-center py-2">
                            Klik "Add Permission" untuk menambahkan hak akses.
                        </p>
                    </div>
                    <p class="text-xs text-muted-foreground mt-2">
                        Format: Resource adalah nama entitas. Actions dipisahkan koma (create, read, update, delete).
                    </p>
                </div>
            </div>
