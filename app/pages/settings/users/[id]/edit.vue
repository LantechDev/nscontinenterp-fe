...
onMounted(async () => {
    try {
        ...
        fetchError.value = e.message || "Terjadi kesalahan saat memuat data.";
    ...
    <div class="space-y-6 animate-fade-in">
        <div class="page-header">
            <div class="flex items-center gap-4">
                <NuxtLink :to="`/settings/users/${userId}`" class="p-2 rounded-lg hover:bg-muted transition-colors">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input v-model="form.password" type="password"
                                    placeholder="Biarkan kosong jika tidak diubah" class="input-field"
                            ...
                            <div class="space-y-2">
                                ...
                                <p v-if="errors.confirmPassword" class="text-xs text-red-500">{{ errors.confirmPassword
                                    }}</p>
                            </div>
                        </div>
                    </div>
    ...
    <div v-if="showDeleteConfirm"
        ...
        <div class="bg-background rounded-lg shadow-lg max-w-md w-full p-6 mx-4">
            ...
            <div class="flex justify-end gap-3">
                <button type="button" @click="showDeleteConfirm = false" class="btn-secondary" :disabled="isDeleting">
                    Batal
                </button>
