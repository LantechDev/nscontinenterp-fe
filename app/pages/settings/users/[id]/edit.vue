    ...
    <div class="space-y-6 animate-fade-in">
        ...
        <div v-else>
            ...
            >
                ...
                <p>{{ fetchError }}</p>
                <button @click="router.go(0)" class="text-sm underline mt-2">
                    Coba lagi/Refresh
                </button>
            </div>
            ...
            <form @submit.prevent="handleSubmit" class="card-elevated p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-2 border-t pt-4 mt-2">
                        <p class="text-sm font-medium mb-4 text-muted-foreground">
                ...
                <div class="flex justify-end items-center gap-6 pt-4 border-t border-border">
                    <NuxtLink :to="`/settings/users/${userId}`" class="btn-secondary"
                        >Batal</NuxtLink
                    >
