    ...
    <div class="space-y-6 animate-fade-in pb-10">
        ...
        <div class="flex items-center justify-between gap-4">
            <div class="relative w-full max-w-sm">
                ...
                <input type="text" placeholder="Cari job untuk closing..."
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <tr v-for="job in closingJobs" :key="job.id"
                            ...
                            <td class="py-3 px-4 text-sm text-green-600 font-medium">{{ job.totalRevenue }}</td>
                            <td class="py-3 px-4 text-sm text-red-600 font-medium">{{ job.totalCost }}</td>
                            <td class="py-3 px-4 text-sm text-[#012D5A] font-bold">{{ job.profit }}</td>
                            <td class="py-3 px-4">
                                <span v-if="job.status === 'closed'"
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div v-for="job in closingJobs" :key="job.id"
