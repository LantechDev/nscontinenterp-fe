    ...
    <div class="space-y-6 animate-fade-in pb-10">
        ...
        <div class="flex items-center justify-between gap-4">
            <div class="relative w-full max-w-sm">
                ...
                <input type="text" placeholder="Cari penawaran..."
            ...
            <div class="flex items-center gap-3">
                ...
                <NuxtLink to="/sales/quotation/create"
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-border bg-white text-left">
                            <th class="py-3 px-4 text-sm font-medium text-foreground">No. Penawaran</th>
                    ...
                    <tbody>
                        <tr v-for="quotation in quotations" :key="quotation.id"
                            ...
                            <td class="py-3 px-4 text-sm text-muted-foreground">{{ quotation.date }}</td>
            ...
            <div v-for="quotation in quotations" :key="quotation.id"
                ...
                <div class="flex items-start justify-between mb-4">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="font-bold text-base text-foreground">{{ quotation.number }}</h3>
