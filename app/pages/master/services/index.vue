...
const services = ref([
    { id: "1", name: "Ocean Freight - FCL", code: "SVC-001", price: "Rp 15.000.000", unit: "Per Container", selected: false, status: "Active" },
    { id: "2", name: "Ocean Freight - LCL", code: "SVC-002", price: "Rp 2.500.000", unit: "Per CBM", selected: false, status: "Active" },
    { id: "3", name: "Trucking - 20ft", code: "SVC-003", price: "Rp 3.500.000", unit: "Per Trip", selected: false, status: "Active" },
    { id: "4", name: "Customs Clearance", code: "SVC-004", price: "Rp 1.200.000", unit: "Per Shipment", selected: false, status: "Inactive" },
    { id: "5", name: "Warehousing", code: "SVC-005", price: "Rp 50.000", unit: "Per CBM/Day", selected: false, status: "Active" },
]);
...
<template>
    <div class="space-y-6 animate-fade-in pb-10">
                        ...
                        <tr v-for="service in services" :key="service.id"
                            ...
                            <td class="py-3 px-4">
                                <span :class="cn(
                                    ...
                                    service.status === 'Active' ? 'text-blue-500 border-blue-200' : 'text-red-500 border-red-200'
                                )">
                                    {{ service.status }}
                                </span>
                            </td>
        ...
        <!-- Create Modal -->
        <UiModal v-model="isCreateOpen" title="Add new Service" description="Register your new Service"
            width="max-w-xl">
            <form class="space-y-4">
                <div class="space-y-1.5">
                    <label class="text-sm font-medium text-foreground">Service Name <span
                            class="text-red-500">*</span></label>
                    <input type="text" placeholder="e.g. Ocean Freight"
                        class="w-full px-3 py-2 rounded-lg border border-border focus:outline-none focus:ring-1 focus:ring-primary" />
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        <label class="text-sm font-medium text-foreground">Code <span
                                class="text-red-500">*</span></label>
                        <input type="text" placeholder="SVC-XXX"
                            class="w-full px-3 py-2 rounded-lg border border-border focus:outline-none focus:ring-1 focus:ring-primary" />
                    </div>
                    <div class="space-y-1.5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        <label class="text-sm font-medium text-foreground">Price <span
                                class="text-red-500">*</span></label>
                        <input type="text" placeholder="Rp 0"
                            class="w-full px-3 py-2 rounded-lg border border-border focus:outline-none focus:ring-1 focus:ring-primary" />
                    </div>
                    <div class="space-y-1.5">
                        <label class="text-sm font-medium text-foreground">Unit <span
                                class="text-red-500">*</span></label>
                        <div class="relative">
                            <select
                                class="w-full px-3 py-2 rounded-lg border border-border bg-white focus:outline-none focus:ring-1 focus:ring-primary appearance-none">
