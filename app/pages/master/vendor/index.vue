...
<template>
    <div class="space-y-6 animate-fade-in pb-10">
                        ...
                        <tr v-for="vendor in vendors" :key="vendor.id"
                            ...
                            <td class="py-3 px-4">
                                <span :class="cn(
                                    ...
                                    vendor.status === 'Active' ? 'text-blue-500 border-blue-200' : 'text-red-500 border-red-200'
                                )">
                                    {{ vendor.status }}
                                </span>
                            </td>
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
            <div v-for="vendor in vendors" :key="vendor.id"
                ...
                <div class="flex items-center justify-between pt-4 border-t border-border">
                    <span class="px-2 py-1 rounded bg-gray-100 text-gray-700 text-xs font-medium">{{ vendor.type
                        }}</span>
                    <span :class="cn(
                        'px-2 py-0.5 rounded border text-xs font-medium bg-white',
                        vendor.status === 'Active' ? 'text-blue-500 border-blue-200' : 'text-red-500 border-red-200'
        ...
        <!-- Create Modal -->
        <UiModal v-model="isCreateOpen" title="Add new Vendor" description="Register your new Vendor" width="max-w-4xl">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            <label class="text-sm font-medium text-foreground">Vendor Code <span
                                    class="text-red-500">*</span></label>
                            <input type="text" placeholder="VND-XXX"
