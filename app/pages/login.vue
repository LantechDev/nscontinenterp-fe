        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-primary relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center px-12 xl:px-20">
                <div class="flex items-center gap-4 mb-8">
                    <div class="flex items-center justify-center w-14 h-14 rounded-2xl bg-white/20 backdrop-blur-sm">
                        <img src="/favicon.png" alt="Logo" class="w-9 h-9" />
                    </div>
                    <div>
                        <h1 class="text-3xl font-bold text-white">Lantech</h1>
                ...
                <div class="space-y-6 max-w-md">
                    ...
                    <p class="text-lg text-white/80">
                        Sistem terintegrasi untuk operasional, penjualan, keuangan,
                        dan pelaporan dalam satu platform.
                    </p>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="password" v-model="password" :type="showPassword ? 'text' : 'password'"
                                placeholder="••••••••" class="input-field pr-12" required />
                            <button type="button"
