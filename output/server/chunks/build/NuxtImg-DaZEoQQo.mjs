...
function createOperationsGenerator(config = {}) {
  ...
  const keyMap =
    config.keyMap && typeof config.keyMap !== "function"
...
const ipxRuntime$B_45rxHtqYIAiZ_w2QuDw00_45i3G2VU4rocTlmy2ex5Nwg = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$B_45rxHtqYIAiZ_w2QuDw00_45i3G2VU4rocTlmy2ex5Nwg, defaults: {} },
  },
};
...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const placeholder = computed(() => {
      ...
      const [width = 10, height = width, quality = 50, blur = 3] = Array.isArray(placeholder2)
        ? placeholder2
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    "../node_modules/@nuxt/image/dist/runtime/components/NuxtImg.vue",
  );
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_0 = Object.assign(_sfc_main, { __name: "NuxtImg" });

export { __nuxt_component_0 as _ };
//# sourceMappingURL=NuxtImg-DaZEoQQo.mjs.map
