    ...
    for (; t; )
      try {
        if (
          ...
          B &&
            (n =
              o[0] & 2 ? B.return : o[0] ? B.throw || ((n = B.return) && n.call(B), 0) : B.next) &&
            !(n = n.call(B, o[1])).done)
        )
          return n;
        switch (((B = 0), n && (o = [o[0] & 2, n.value]), o[0])) {
          ...
          default:
            if (
              ((n = t.trys), !(n = n.length > 0 && n[n.length - 1]) && (o[0] === 6 || o[0] === 2))
            ) {
              t = 0;
              continue;
            }
...
var cA = (function () {
    ...
    return (
      ...
      (e.fromDOMRectList = function (A, t) {
        ...
        return r
          ? new e(r.left + A.windowBounds.left, r.top + A.windowBounds.top, r.width, r.height)
          : e.EMPTY;
      }),
  ...
  S = function () {
    ...
    for (var r = [], B = -1, n = ""; ++B < t; ) {
      var s = e[B];
      (s <= 65535 ? r.push(s) : ((s -= 65536), r.push((s >> 10) + 55296, (s % 1024) + 56320)),
    ...
    return (
      (e.prototype.get = function (A) {
        ...
        if (A >= 0) {
          ...
          if (A <= 65535)
            return (
              (t = this.index[BB + ((A - 55296) >> bA)]), (t = (t << ir) + (A & or)), this.data[t]
            );
          if (A < this.highStart)
            return (
              (t = Fn - hn + (A >> zr)),
...
var yn =
  ...
  Vn = function (e, A, t, r, B) {
    ...
    if (
      ...
      ([ee, Ae].indexOf(a) !== -1 && (Q === j || ([ZA, $A].indexOf(Q) !== -1 && A[i + 1] === j))) ||
    ...
    return (
      ...
      (e.prototype.consumeUrlToken = function () {
        ...
        if (t === pe || t === He) {
          ...
          return r.type === 0 &&
            (this.consumeWhiteSpace(), this.peekCodePoint(0) === nA || this.peekCodePoint(0) === jA)
            ? (this.consumeCodePoint(), { type: 22, value: r.value })
            : (this.consumeBadUrlRemnants(), me);
        }
        for (;;) {
          var B = this.consumeCodePoint();
          if (B === nA || B === jA) return { type: 22, value: S.apply(void 0, A) };
          if (ye(B))
            return (
              this.consumeWhiteSpace(),
              this.peekCodePoint(0) === nA || this.peekCodePoint(0) === jA
                ? (this.consumeCodePoint(), { type: 22, value: S.apply(void 0, A) })
                : (this.consumeBadUrlRemnants(), me)
            );
...
var pt = function (e, A) {
  ...
  ra = function (e, A, t, r, B) {
    ...
    switch (e.size) {
      case 0:
        e.shape === 0
          ? (n = s = Math.min(Math.abs(A), Math.abs(A - r), Math.abs(t), Math.abs(t - B)))
          : e.shape === 1 &&
      ...
      case 2:
        if (e.shape === 0) n = s = Math.min(rA(A, t), rA(A, t - B), rA(A - r, t), rA(A - r, t - B));
          ...
          var i = Math.min(Math.abs(t), Math.abs(t - B)) / Math.min(Math.abs(A), Math.abs(A - r)),
            a = vt(r, B, A, t, !0),
            o = a[0],
            Q = a[1];
      ...
      case 1:
        e.shape === 0
          ? (n = s = Math.max(Math.abs(A), Math.abs(A - r), Math.abs(t), Math.abs(t - B)))
          : e.shape === 1 &&
      ...
      case 3:
        if (e.shape === 0) n = s = Math.max(rA(A, t), rA(A, t - B), rA(A - r, t), rA(A - r, t - B));
          ...
          var i = Math.max(Math.abs(t), Math.abs(t - B)) / Math.max(Math.abs(A), Math.abs(A - r)),
            g = vt(r, B, A, t, !1),
            o = g[0],
            Q = g[1];
          ((n = rA(o - A, (Q - t) / i)), (s = i * n));
    ...
    return (
      Array.isArray(e.size) &&
        ((n = b(e.size[0], r)), (s = e.size.length === 2 ? b(e.size[1], B) : n)),
      [n, s]
    );
  },
  ta = function (e, A) {
          ...
          if (Q.name === "from") {
            ...
            if (w.length === 2) {
              var g = EA.parse(e, w[1]),
                f = w[0];
              kA(f) &&
                r.push({ stop: { type: 16, number: f.number * 100, flags: f.flags }, color: g });
            }
          }
        }
      }),
      ...
      sA(A).forEach(function (s, i) {
        ...
        if (i === 0) {
          ...
          a = s.reduce(function (g, w) {
            ...
            else if (pA(w) || M(w)) return (Array.isArray(r) || (r = []), r.push(w), !1);
            return g;
          }, a);
        }
        if (a) {
          ...
          (i === 0
            ...
            : i === 1 &&
              (a = s.reduce(function (Q, g) {
                ...
                else if (pA(g) || M(g)) return (Array.isArray(r) || (r = []), r.push(g), !1);
                return Q;
              }, a)),
          a)
        ) {
...
var Ca = {
  ...
  La = nr("bottom"),
  Da = nr("left"),
  ba = { name: "color", initialValue: "transparent", prefix: !1, type: 3, format: "color" },
  xa = {
    name: "direction",
    initialValue: "ltr",
    prefix: !1,
  ...
  Ai = {
    ...
    parse: function (e, A) {
      return A.length === 1 && Xr(A[0], "none")
        ...
        : sA(A).map(function (t) {
            for (
              var r = { color: wA.TRANSPARENT, offsetX: X, offsetY: X, blur: X }, B = 0, n = 0;
              n < t.length;
              n++
            ) {
              var s = t[n];
              pA(s)
                ? (B === 0 ? (r.offsetX = s) : B === 1 ? (r.offsetY = s) : (r.blur = s), B++)
...
var oi = {
  ...
  ui = { name: "font-size", initialValue: "0", prefix: !1, type: 3, format: "length" },
  li = {
    name: "font-weight",
    initialValue: "normal",
    type: 0,
  ...
  pi = {
    ...
    parse: function (e, A) {
      return A.length === 1 && Xr(A[0], "none")
        ...
        : sA(A).map(function (t) {
            for (
              var r = { color: 255, offsetX: X, offsetY: X, blur: X, spread: X, inset: !1 },
                B = 0,
                n = 0;
              n < t.length;
              n++
    ...
    function e(A, t) {
      ...
      ((this.overflowX = n[0]),
        ...
        (this.textDecorationLine = U(
          A,
          ci,
          (B = t.textDecorationLine) !== null && B !== void 0 ? B : t.textDecoration,
        )),
    ...
    return (
      (e.prototype.get = function (A) {
        ...
        if (A >= 0) {
          ...
          if (A <= 65535)
            return (
              (t = this.index[MB + ((A - 55296) >> xA)]), (t = (t << lr) + (A & fr)), this.data[t]
            );
          if (A < this.highStart)
            return (
              (t = Xi - _i + (A >> et)),
...
var qi = 1,
          ...
          if (N.SUPPORT_RANGE_BOUNDS) {
            ...
            if (a.length > 1) {
              ...
              o.forEach(function (w) {
                (n.push(new ie(w, cA.fromDOMRectList(e, _t(r, Q + s, w.length).getClientRects()))),
                  (Q += w.length));
              });
  ...
  kr = (function (e) {
    ...
    function A(t, r) {
      var B = e.call(this, t, r) || this;
      return (
        (B.start = r.start), (B.reversed = typeof r.reversed == "boolean" && r.reversed === !0), B
      );
    }
    return A;
  })(aA),
      ...
      try {
        if (
          ...
          var n = r.contentWindow.document.documentElement
              ? se(t, getComputedStyle(r.contentWindow.document.documentElement).backgroundColor)
              : wA.TRANSPARENT,
            s = r.contentWindow.document.body
              ? se(t, getComputedStyle(r.contentWindow.document.body).backgroundColor)
              : wA.TRANSPARENT;
  ...
  $t = (function () {
    ...
    return (
        ...
        try {
          ...
          if (s)
            if (!this.options.allowTaint && n)
              ...
              var i =
                (t = A.getContext("webgl2")) !== null && t !== void 0 ? t : A.getContext("webgl");
              if (i) {
      ...
      (e.prototype.cloneChildNodes = function (A, t, r) {
        for (
          var B = this, n = A.shadowRoot ? A.shadowRoot.firstChild : A.firstChild;
          n;
          n = n.nextSibling
        )
      ...
      (e.prototype.cloneNode = function (A, t) {
        ...
        if (r && _A(A) && (Yr(A) || Ne(A))) {
          ...
          (this.referenceElement === A && Yr(B) && (this.clonedReferenceElement = B),
            Bt(B) && Wo(B));
          ...
          return (
            Q && B.appendChild(Q),
            this.counters.pop(a),
            ((n && (this.options.copyStyles || Ne(A)) && !qB(A)) || t) && Ir(n, B),
  ...
  qo = (function () {
    ...
    return (
      (e.prototype.addImage = function (A) {
        ...
        return (
          this.has(A) ||
            ((yr(A) || AQ(A)) && (this._cache[A] = this.loadImage(A)).catch(function () {})),
          t
        );
      }),
          ...
          return _(this, function (i) {
            switch (i.label) {
              case 0:
                return (
                  (t = An.isSameOrigin(A)),
                  (r = !vr(A) && this._options.useCORS === !0 && N.SUPPORT_CORS_IMAGES && !t),
                  (B =
                    !vr(A) &&
                    !t &&
                    !yr(A) &&
                    ...
                    N.SUPPORT_CORS_XHR &&
                    !r),
                  !t && this._options.allowTaint === !1 && !vr(A) && !yr(A) && !B && !r
                    ? [2]
    ...
    function e(A) {
      ...
      ((this.topLeftBorderDoubleOuterBox =
        ...
        (this.topRightBorderDoubleInnerBox =
          n > 0 || s > 0
            ? x(r.left + F, r.top + (l * 2) / 3, a - (v * 2) / 3, o - (l * 2) / 3, m.TOP_RIGHT)
            : new u(r.left + r.width - (v * 2) / 3, r.top + (l * 2) / 3)),
        (this.bottomRightBorderDoubleInnerBox =
          g > 0 || w > 0
            ? x(r.left + p, r.top + K, g - (v * 2) / 3, w - (y * 2) / 3, m.BOTTOM_RIGHT)
            : new u(r.left + r.width - (v * 2) / 3, r.top + r.height - (y * 2) / 3)),
        (this.bottomLeftBorderDoubleInnerBox =
          c > 0 || C > 0
            ? x(r.left + (E * 2) / 3, r.top + d, c - (E * 2) / 3, C - (y * 2) / 3, m.BOTTOM_LEFT)
        ...
        (this.topLeftBorderBox =
          n > 0 || s > 0 ? x(r.left, r.top, n, s, m.TOP_LEFT) : new u(r.left, r.top)),
        ...
        (this.topLeftPaddingBox =
          n > 0 || s > 0
            ? x(r.left + E, r.top + l, Math.max(0, n - E), Math.max(0, s - l), m.TOP_LEFT)
        ...
        (this.bottomLeftContentBox =
          c > 0 || C > 0
            ? x(r.left + E + L, r.top + d, Math.max(0, c - (E + L)), C - (y + q), m.BOTTOM_LEFT)
...
var x = function (e, A, t, r, B) {
  ...
  jr = function (e, A, t, r) {
    e.container.elements.forEach(function (B) {
      ...
      if (n || s) {
        ...
        (B.styles.isInlineLevel() ? A.inlineLevel.push(i) : A.nonInlineLevel.push(i),
          jr(i, A, t, a));
      G(B.flags, 8) && Bn(B, a);
    });
  },
  Bn = function (e, A) {
    for (
      var t = e instanceof kr ? e.start : 1, r = e instanceof kr ? e.reversed : !1, B = 0;
      B < A.length;
      B++
    ) {
      var n = A[B];
  ...
  UQ = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",
  tB = "Hidden Text",
  FQ = (function () {
    function e(A) {
    ...
    return (
      ...
      (e.prototype.getMetrics = function (A, t) {
        var r = A + " " + t;
        return (
          typeof this._data[r] > "u" && (this._data[r] = this.parseMetrics(A, t)), this._data[r]
        );
      }),
      e
    );
    ...
    return (
      ...
      (A.prototype.createFontStyle = function (t) {
        var r = t.fontVariant
          ...
          n = Ce(t.fontSize) ? "" + t.fontSize.number + t.fontSize.unit : t.fontSize.number + "px";
                  ...
                  switch (C) {
                    case 0:
                      ...
                      (H.length &&
                        ...
                        (H.slice(0)
                          ...
                          .forEach(function (h) {
                            ((w.ctx.shadowColor = R(h.color)),
                              (w.ctx.shadowOffsetX = h.offsetX.number * w.options.scale),
                              (w.ctx.shadowOffsetY = h.offsetY.number * w.options.scale),
                        ...
                        r.textDecorationLine.length &&
                          ((w.ctx.fillStyle = R(r.textDecorationColor || r.color)),
                    ...
                    case 1:
                      (r.webkitTextStrokeWidth &&
                        ...
                        w.ctx.strokeText(c.text, c.bounds.left, c.bounds.top + o)),
                        (w.ctx.strokeStyle = ""),
                        (w.ctx.lineWidth = 0),
        ...
        return P(this, void 0, void 0, function () {
          ...
          return _(this, function (l) {
            switch (l.label) {
              ...
              case 7:
                return (
                  l.sent(), this.context.logger.error("Error loading image " + r.src), [3, 8]
                );
              case 8:
                if (
                  (r instanceof RB && this.renderReplacedElement(r, B, r.canvas),
                  !(r instanceof VB))
                )
                  return [3, 12];
                l.label = 9;
              ...
              case 14:
                if (
                  ...
                  ((H = d.add(C, 0, 0, -d.height / 2 + 1)),
                    ...
                    this.ctx.clip(),
                    this.renderTextWithLetterSpacing(new ie(r.value, H), n.letterSpacing, c),
                    this.ctx.restore(),
                    (this.ctx.textBaseline = "alphabetic"),
                    (this.ctx.textAlign = "left"));
                }
      ...
      (A.prototype.resizeImage = function (t, r, B) {
        ...
        var s = (n = this.canvas.ownerDocument) !== null && n !== void 0 ? n : document,
                    ...
                    return _(this, function (TA) {
                      switch (TA.label) {
                        ...
                        case 3:
                          return (
                            TA.sent(),
                            n.context.logger.error("Error loading background-image " + w),
                            [3, 4]
                          );
                        case 4:
                          return (
                            g &&
                              ((f = Kr(t, r, [g.width, g.height, g.width / g.height])),
                              (O = f[0]),
                              (Y = f[1]),
                              (W = f[2]),
                              (L = f[3]),
                              (V = f[4]),
                              (y = n.ctx.createPattern(n.resizeImage(g, L, V), "repeat")),
                        ...
                        case 5:
                          (sa(Q)
                            ...
                            : aa(Q) &&
                              ...
                              (L = E[3]),
                              (V = E[4]),
                              (CA = Q.position.length === 0 ? [$r] : Q.position),
                              (Y = b(CA[0], L)),
                              ...
                              BA > 0 &&
                                ...
                                (n.ctx.fillStyle = vA),
                                BA !== uA
                                  ? ((yA = t.bounds.left + 0.5 * t.bounds.width),
                                    ...
                                    n.ctx.translate(-yA, -iA),
                                    n.ctx.fillRect(k, oA * (q - iA) + iA, L, V * oA),
                                    n.ctx.restore())
                                  : n.ctx.fill())),
                            (TA.label = 6));
                        case 6:
          ...
          return _(this, function (w) {
            switch (w.label) {
                  ...
                  B || r.boxShadow.length
                    ? (this.ctx.save(),
                      ...
                      HA(r.backgroundColor) ||
                        ((this.ctx.fillStyle = R(r.backgroundColor)), this.ctx.fill()),
                  ...
                  r.boxShadow
                    ...
                    .forEach(function (f) {
                      ...
                      (f.inset
                        ...
                        (g.ctx.fillStyle = f.inset ? R(f.color) : "rgba(0,0,0,1)"),
                        g.ctx.fill(),
                        g.ctx.restore());
                    }),
                  (w.label = 2));
                ...
                return a < o.length
                  ? ((Q = o[a]),
                    Q.style !== 0 && !HA(Q.color) && Q.width > 0
                      ? Q.style !== 2
                        ? [3, 5]
                        : [4, this.renderDashedDottedBorder(Q.color, Q.width, i, t.curves, 2)]
                      : [3, 11])
                  : [3, 13];
              case 4:
                return (w.sent(), [3, 11]);
              case 5:
                return Q.style !== 3
                  ? [3, 7]
                  : [4, this.renderDashedDottedBorder(Q.color, Q.width, i, t.curves, 3)];
              case 6:
                return (w.sent(), [3, 11]);
              case 7:
                return Q.style !== 4
        ...
        return P(this, void 0, void 0, function () {
          ...
          return _(this, function (v) {
            return (
              ...
              $(a[0]) ? ((o = a[0].start.x), (Q = a[0].start.y)) : ((o = a[0].x), (Q = a[0].y)),
              $(a[1]) ? ((g = a[1].end.x), (w = a[1].end.y)) : ((g = a[1].x), (w = a[1].y)),
              B === 0 || B === 2 ? (f = Math.abs(o - g)) : (f = Math.abs(Q - w)),
              this.ctx.beginPath(),
              ...
              H && (s === 3 ? this.ctx.setLineDash([0, c + C]) : this.ctx.setLineDash([c, C])),
              s === 3
              ...
              s === 2 &&
                ($(a[0]) &&
                  ...
                  (l = a[0]),
                  this.ctx.beginPath(),
                  this.formatPath([new u(d.end.x, d.end.y), new u(l.start.x, l.start.y)]),
                  this.ctx.stroke()),
                $(a[1]) &&
                  ((d = a[1]),
                  (l = a[2]),
  ...
  mQ = (function () {
    ...
    return (
      (e.prototype.debug = function () {
        ...
        this.enabled &&
          (typeof window < "u" && window.console && typeof console.debug == "function"
            ? console.debug.apply(console, ue([this.id, this.getTime() + "ms"], A))
      ...
      (e.prototype.warn = function () {
        for (var A = [], t = 0; t < arguments.length; t++) A[t] = arguments[t];
        this.enabled &&
          (typeof window < "u" && window.console && typeof console.warn == "function"
            ? console.warn.apply(console, ue([this.id, this.getTime() + "ms"], A))
            : this.info.apply(this, A));
      }),
      (e.prototype.error = function () {
        for (var A = [], t = 0; t < arguments.length; t++) A[t] = arguments[t];
        this.enabled &&
          (typeof window < "u" && window.console && typeof console.error == "function"
            ? console.error.apply(console, ue([this.id, this.getTime() + "ms"], A))
            : this.info.apply(this, A));
      }),
      (e.instances = {}),
      e
...
var DQ = function (e, A) {
        ...
        switch (oA.label) {
          case 0:
            ...
            return (
              ...
              (n = Lr(
                { logging: (k = A.logging) !== null && k !== void 0 ? k : !0, cache: A.cache },
                B,
              )),
              (s = {
              ...
              (a = new LQ(n, i)),
              (o = (Y = A.foreignObjectRendering) !== null && Y !== void 0 ? Y : !1),
              (Q = {
          ...
          case 1:
            return (
              ...
              (p = {
                ...
                backgroundColor: K,
                scale:
                  (BA = (IA = A.scale) !== null && IA !== void 0 ? IA : r.devicePixelRatio) !==
                    null && BA !== void 0
                    ? BA
                    : 1,
          ...
          case 3:
            return (
              ...
              (l = kB(a, w)),
              K === l.styles.backgroundColor && (l.styles.backgroundColor = wA.TRANSPARENT),
              a.logger.debug(
  ...
  bQ = function (e, A, t) {
    var r = A.ownerDocument,
      ...
      s = typeof t == "string" ? se(e, t) : t === null ? wA.TRANSPARENT : 4294967295;
