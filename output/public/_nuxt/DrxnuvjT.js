function ye(e) {
  ...
  if (typeof e == "string" || typeof e == "number") r += e;
    ...
    if (Array.isArray(e)) {
      var i = e.length;
      for (o = 0; o < i; o++) e[o] && (t = ye(e[o])) && (r && (r += " "), (r += t));
    } else for (t in e) e[t] && (r && (r += " "), (r += t));
  return r;
}
function Le() {
  for (var e, o, t = 0, r = "", i = arguments.length; t < i; t++)
    (e = arguments[t]) && (o = ye(e)) && (r && (r += " "), (r += o));
  return r;
}
const Oe = (e, o) => {
  ...
  Ee = (e, o) => ({ classGroupId: e, validator: o }),
  ve = (e = new Map(), o = null, t) => ({ nextPart: e, validators: o, classGroupId: t }),
  K = "-",
  fe = [],
  Ve = "arbitrary..",
  De = (e) => {
    ...
    return {
      getClassGroupId: (a) => {
        if (a.startsWith("[") && a.endsWith("]")) return We(a);
        const u = a.split(K),
  ...
  ze = (e, o, t) => {
    ...
    if (a === null) return;
    const u = o === 0 ? e.join(K) : e.slice(o).join(K),
      d = a.length;
    for (let b = 0; b < d; b++) {
      const h = a[b];
  ...
  Ye = (e, o, t, r) => {
    ...
    (o.validators === null && (o.validators = []), o.validators.push(Ee(t, e)));
  },
  qe = (e, o, t, r) => {
  ...
  Je = (e) => {
    ...
    const i = (m, a) => {
      ((t[m] = a), o++, o > e && ((o = 0), (r = t), (t = Object.create(null))));
    };
    return {
      get(m) {
        let a = t[m];
        if (a !== void 0) return a;
        if ((a = r[m]) !== void 0) return (i(m, a), a);
      },
      set(m, a) {
        m in t ? (t[m] = a) : i(m, a);
      },
  ...
  Ke = (e) => {
    ...
    let r = (i) => {
      ...
      const T = b && b > d ? b - d : void 0;
      return he(m, P, A, T);
    };
    if (o) {
      const i = o + ge,
        m = r;
      r = (a) => (a.startsWith(i) ? m(a.slice(i.length)) : he(He, !1, a, void 0, !0));
    }
    if (t) {
      const i = r;
      r = (m) => t({ className: m, parseClassName: i });
    }
    return r;
  },
  Qe = (e) => {
      ...
      (t) => {
        ...
        for (let m = 0; m < t.length; m++) {
          const a = t[m],
            u = a[0] === "[",
            d = o.has(a);
          u || d ? (i.length > 0 && (i.sort(), r.push(...i), (i = [])), r.push(a)) : i.push(a);
        }
        return (i.length > 0 && (i.sort(), r.push(...i)), r);
      }
    );
  },
  Ze = (e) => ({ cache: Je(e.cacheSize), parseClassName: Ke(e), sortModifiers: Qe(e), ...De(e) }),
  eo = /\s+/,
  oo = (e, o) => {
    const {
        parseClassName: t,
    ...
    for (let b = u.length - 1; b >= 0; b -= 1) {
      ...
      const B = A.length === 0 ? "" : A.length === 1 ? A[0] : m(A).join(":"),
        D = P ? B + se : B,
        O = D + G;
  ...
  ro = (...e) => {
    let o = 0,
      ...
      r,
      i = "";
    for (; o < e.length; ) (t = e[o++]) && (r = Ae(t)) && (i && (i += " "), (i += r));
    return i;
  },
  Ae = (e) => {
    ...
    let o,
      t = "";
    for (let r = 0; r < e.length; r++) e[r] && (o = Ae(e[r])) && (t && (t += " "), (t += o));
    return t;
  },
  to = (e, ...o) => {
    let t, r, i, m;
    const a = (d) => {
        const b = o.reduce((h, v) => v(h), e());
        return ((t = Ze(b)), (r = t.cache.get), (i = t.cache.set), (m = u), u(d));
      },
      u = (d) => {
        const b = r(d);
        if (b) return b;
  ...
  Ao = () => {
    const e = f("color"),
      ...
      V = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"],
      C = () => ["auto", ...l()],
      F = () => [
        R,
        "auto",
      ...
      c = () => [e, n, s],
      de = () => [...O(), ke, xe, { position: [n, s] }],
      me = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }],
      pe = () => ["auto", "cover", "contain", yo, go, { size: [n, s] }],
      oe = () => [te, _, j],
      w = () => ["", "none", "full", b, n, s],
      x = () => ["", p, _, j],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: ["auto", "square", R, s, n, k] }],
        container: ["container"],
        ...
        z: [{ z: [I, "auto", n, s] }],
        basis: [{ basis: [R, "full", "auto", u, ...l()] }],
        "flex-direction": [{ flex: ["row", "row-reverse", "col", "col-reverse"] }],
        "flex-wrap": [{ flex: ["nowrap", "wrap", "wrap-reverse"] }],
        flex: [{ flex: [p, R, "auto", "initial", "none", s] }],
        grow: [{ grow: ["", p, n, s] }],
        shrink: [{ shrink: ["", p, n, s] }],
        ...
        w: [{ w: [u, "screen", ...F()] }],
        "min-w": [{ "min-w": [u, "screen", "none", ...F()] }],
        "max-w": [{ "max-w": [u, "screen", "none", "prose", { screen: [a] }, ...F()] }],
        h: [{ h: ["screen", "lh", ...F()] }],
        "min-h": [{ "min-h": ["screen", "lh", "none", ...F()] }],
        "max-h": [{ "max-h": ["screen", "lh", ...F()] }],
        "font-size": [{ text: ["base", t, _, j] }],
        ...
        "drop-shadow": [{ "drop-shadow": ["", "none", P, H, J] }],
        ...
        delay: [{ delay: [p, n, s] }],
        animate: [{ animate: ["none", B, n, s] }],
        backface: [{ backface: ["hidden", "visible"] }],
        perspective: [{ perspective: [z, n, s] }],
...
function To(e) {
  ...
  return isNaN(o)
    ? "Rp0"
    : o >= 1e12
      ? `Rp${(o / 1e12).toFixed(1).replace(".", ",")}T`
      : o >= 1e9
        ? `Rp${(o / 1e9).toFixed(1).replace(".", ",")}M`
        : o >= 1e6
          ? `Rp${(o / 1e6).toFixed(1).replace(".", ",")}jt`
          : o >= 1e3
            ? `Rp${(o / 1e3).toFixed(1).replace(".", ",")}rb`
...
function Go(e) {
  ...
  return e instanceof Error ? e.message : typeof e == "string" ? e : "An unknown error occurred";
}
export { Mo as a, Po as b, Io as c, To as f, Go as g, Ro as t };
