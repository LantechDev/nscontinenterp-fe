...
let { freeze: S, seal: b, create: me } = Object,
...
const fe = R(Array.prototype.forEach),
...
function Jt(s) {
  for (let o = 0; o < s.length; o++) L(s, o) || (s[o] = null);
  return s;
}
function C(s) {
  const o = me(null);
...
const Q = { element: 1, text: 3, progressingInstruction: 7, comment: 8, document: 9 },
  fn = function () {
...
function ht() {
  ...
  if (
    ((o.version = "3.3.3"),
    (o.removed = []),
    !s || !s.document || s.document.nodeType !== Q.document || !s.Element)
  )
  ...
  let A = Et();
  o.isSupported =
    typeof _t == "function" && typeof te == "function" && de && de.createHTMLDocument !== void 0;
  const {
    MUSTACHE_EXPR: Ee,
    ERB_EXPR: _e,
    TMPLIT_EXPR: ge,
  ...
  const Gt = l.createElement("form"),
    ...
    ye = function () {
      ...
      if (!(G && G === e)) {
        if (
          ...
          (p = $ === "application/xhtml+xml" ? Ie : pe),
          (T = L(e, "ALLOWED_TAGS") ? r({}, e.ALLOWED_TAGS, p) : Ge),
          (d = L(e, "ALLOWED_ATTR") ? r({}, e.ALLOWED_ATTR, p) : We),
          (be = L(e, "ALLOWED_NAMESPACES") ? r({}, e.ALLOWED_NAMESPACES, Ie) : Ut),
          (Oe = L(e, "ADD_URI_SAFE_ATTR") ? r(C(Ke), e.ADD_URI_SAFE_ATTR, p) : Ke),
          ($e = L(e, "ADD_DATA_URI_TAGS") ? r(C(qe), e.ADD_DATA_URI_TAGS, p) : qe),
          (y = L(e, "FORBID_CONTENTS") ? r({}, e.FORBID_CONTENTS, p) : De),
          (j = L(e, "FORBID_TAGS") ? r({}, e.FORBID_TAGS, p) : C({})),
          (ne = L(e, "FORBID_ATTR") ? r({}, e.FORBID_ATTR, p) : C({})),
          (H = L(e, "USE_PROFILES") ? e.USE_PROFILES : !1),
          (Be = e.ALLOW_ARIA_ATTR !== !1),
          (Ae = e.ALLOW_DATA_ATTR !== !1),
          (Ye = e.ALLOW_UNKNOWN_PROTOCOLS || !1),
          (Xe = e.ALLOW_SELF_CLOSE_IN_ATTR !== !1),
          (U = e.SAFE_FOR_TEMPLATES || !1),
          (oe = e.SAFE_FOR_XML !== !1),
          ...
          (Re = e.KEEP_CONTENT !== !1),
          (V = e.IN_PLACE || !1),
          (ze = e.ALLOWED_URI_REGEXP || gt),
          (z = e.NAMESPACE || I),
          (le = e.MATHML_TEXT_INTEGRATION_POINTS || le),
          (ce = e.HTML_INTEGRATION_POINTS || ce),
          ...
          H &&
            ((T = r({}, mt)),
            (d = me(null)),
            H.html === !0 && (r(T, ut), r(d, pt)),
            H.svg === !0 && (r(T, we), r(d, ke), r(d, ue)),
            H.svgFilters === !0 && (r(T, xe), r(d, ke), r(d, ue)),
            H.mathMl === !0 && (r(T, Pe), r(d, Tt), r(d, ue))),
          L(e, "ADD_TAGS") || (x.tagCheck = null),
          L(e, "ADD_ATTR") || (x.attributeCheck = null),
          e.ADD_TAGS &&
            (typeof e.ADD_TAGS == "function"
              ? (x.tagCheck = e.ADD_TAGS)
              : (T === Ge && (T = C(T)), r(T, e.ADD_TAGS, p))),
          e.ADD_ATTR &&
            (typeof e.ADD_ATTR == "function"
              ? (x.attributeCheck = e.ADD_ATTR)
              : (d === We && (d = C(d)), r(d, e.ADD_ATTR, p))),
          e.ADD_URI_SAFE_ATTR && r(Oe, e.ADD_URI_SAFE_ATTR, p),
          e.FORBID_CONTENTS && (y === De && (y = C(y)), r(y, e.FORBID_CONTENTS, p)),
          e.ADD_FORBID_CONTENTS && (y === De && (y = C(y)), r(y, e.ADD_FORBID_CONTENTS, p)),
          Re && (T["#text"] = !0),
          P && r(T, ["html", "head", "body"]),
          T.table && (r(T, ["tbody"]), delete j.tbody),
          ...
          (g === void 0 && (g = un(ee, c)),
            g !== null && typeof X == "string" && (X = g.createHTML("")));
        (S && S(e), (G = e));
      }
    },
    Je = r({}, [...we, ...xe, ...Qt]),
    ...
    Wt = function (e) {
      let t = te(e);
      (!t || !t.tagName) && (t = { namespaceURI: z, tagName: "template" });
          ...
          : e.namespaceURI === re
            ? t.namespaceURI === I
              ...
              : t.namespaceURI === se
                ...
                : !!Qe[n]
            : e.namespaceURI === I
              ? (t.namespaceURI === se && !ce[f]) || (t.namespaceURI === re && !le[f])
                ? !1
                : !Qe[n] && (Ft[n] || !Je[n])
    ...
    et = function (e) {
      ...
      return (
        ...
        z === I ? It.call(t, P ? "html" : "body")[0] : P ? t.documentElement : _
      );
    },
    tt = function (e) {
      return Nt.call(
  ...
  const ot = function (e) {
      let t = null;
      if ((M(A.beforeSanitizeElements, e, null), Ne(e))) return (N(e), !0);
      const n = p(e.nodeName);
      if (
        (M(A.uponSanitizeElement, e, { tagName: n, allowedTags: T }),
        (oe &&
          e.hasChildNodes() &&
          ...
          (oe && e.nodeType === Q.comment && h(/<[/\w]/g, e.data)))
      )
        return (N(e), !0);
      if (!(x.tagCheck instanceof Function && x.tagCheck(n)) && (!T[n] || j[n])) {
        if (
          !j[n] &&
          at(n) &&
          ((u.tagNameCheck instanceof RegExp && h(u.tagNameCheck, n)) ||
            (u.tagNameCheck instanceof Function && u.tagNameCheck(n)))
        )
          return !1;
        if (Re && !y[n]) {
          const f = te(e) || e.parentNode,
            _ = yt(e) || e.childNodes;
          if (_ && f) {
            const m = _.length;
            for (let O = m - 1; O >= 0; --O) {
      ...
      return (e instanceof Fe && !Wt(e)) ||
        ((n === "noscript" || n === "noembed" || n === "noframes") &&
          h(/<\/no(script|embed|frames)/i, e.innerHTML))
        ? (N(e), !0)
        : (U &&
            e.nodeType === Q.text &&
            ((t = e.textContent),
          ...
          M(A.afterSanitizeElements, e, null),
          !1);
    },
    it = function (e, t, n) {
      if (ne[t] || (je && (t === "id" || t === "name") && (n in l || n in Gt))) return !1;
      if (!(Ae && !ne[t] && h(wt, t))) {
        if (!(Be && h(xt, t))) {
          if (!(x.attributeCheck instanceof Function && x.attributeCheck(t, e))) {
            if (!d[t] || ne[t]) {
              if (
                !(
                  (at(e) &&
                    ((u.tagNameCheck instanceof RegExp && h(u.tagNameCheck, e)) ||
    ...
    rt = function (e) {
      ...
      for (; f--; ) {
        const _ = t[f],
          { name: m, namespaceURI: O, value: w } = _,
          W = p(m),
          Ce = w;
        ...
        if (
          ...
          M(A.uponSanitizeAttribute, e, n),
          (E = n.attrValue),
          Ve && (W === "id" || W === "name") && (k(m, e), (E = vt + E)),
          oe &&
            h(
    ...
    Bt = function i(e) {
      ...
      for (M(A.beforeSanitizeShadowDOM, e, null); (t = n.nextNode()); )
        (M(A.uponSanitizeShadowNode, t, null),
          ot(t),
          rt(t),
          t.content instanceof D && i(t.content));
    ...
    (o.sanitize = function (i) {
      ...
      if ((he || ye(e), (o.removed = []), typeof i == "string" && (V = !1), V)) {
        if (i.nodeName) {
          ...
          if (!T[w] || j[w]) throw Z("root node is forbidden and cannot be sanitized in-place");
        }
      } else if (i instanceof Te)
        ((t = et("<!---->")),
          (n = t.ownerDocument.importNode(i, !0)),
          (n.nodeType === Q.element && n.nodeName === "BODY") || n.nodeName === "HTML"
            ? (t = n)
            : t.appendChild(n));
      else {
        if (!F && !U && !P && i.indexOf("<") === -1) return g && ae ? g.createHTML(i) : i;
        if (((t = et(i)), !t)) return F ? null : ae ? X : "";
      }
      t && Se && N(t.firstChild);
      const m = tt(V ? i : t);
      for (; (f = m.nextNode()); ) (ot(f), rt(f), f.content instanceof D && Bt(f.content));
      if (V) return i;
      if (F) {
        if (ie) for (_ = Ct.call(t.ownerDocument); t.firstChild; ) _.appendChild(t.firstChild);
        else _ = t;
      ...
      return (
        P &&
          ...
          h(At, t.ownerDocument.doctype.name) &&
          (O =
            "<!DOCTYPE " +
            t.ownerDocument.doctype.name +
            `>
