...
import { R as u, _ as c, Q as t, T as n, a2 as l, P as d, V as f } from "./D9q6143x.js";
const p = {
    class:
  ...
  m = { class: "max-w-520px text-center" },
  h = ["textContent"],
  g = ["textContent"],
  b = ["textContent"],
  x = { class: "flex items-center justify-center w-full" },
  y = {
    __name: "error-404",
    props: {
    ...
    setup(e) {
      ...
      return (
        i({
          title: `${r.statusCode} - ${r.statusMessage} | ${r.appName}`,
          script: [
            {
          ...
          return (
            ...
            u("div", p, [
              t("div", m, [
                ...
                t(
                  "p",
                  { class: "mb-4 px-2 text-[#64748B] text-md", textContent: n(e.description) },
                  null,
                  8,
                  b,
                ),
                t("div", x, [
                  l(
                    ...
                    { default: d(() => [f(n(e.backHome), 1)]), _: 1 },
                  ),
                ]),
              ]),
            ])
  ...
  z = a(y, [["__scopeId", "data-v-cd31e6b7"]]);
export { z as default };
