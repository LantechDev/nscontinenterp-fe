import { _ as Va } from "./BS85nYjr.js";
import "./D9q6143x.js";
var La =
  typeof globalThis < "u"
    ? globalThis
...
function Ua() {
  return (
    bn ||
      ((bn = 1),
      (at = function (n, e) {
        return { enumerable: !(n & 1), configurable: !(n & 2), writable: !(n & 4), value: e };
      })),
    at
  );
}
  ...
  return (
    (yt =
      ...
      !e(function () {
        ...
        return !t(i) || !(Object(i) instanceof Symbol) || (!Symbol.sham && n && n < 41);
      })),
    yt
  );
}
      ...
      ? r
        ? function (v, f, g) {
            if (
              ...
              (f = i(f)),
              t(g),
              typeof v == "function" && f === "prototype" && "value" in g && h in g && !g[h])
            ) {
              var d = o(v, f);
              d &&
                d[h] &&
...
function cl() {
  ...
  var n = J(),
    ...
    y = (Bt.exports = function (m, b, x) {
      (v(h(b), 0, 7) === "Symbol(" && (b = "[" + f(h(b), /^Symbol\(([^)]*)\).*$/, "$1") + "]"),
        x && x.getter && (b = "get " + b),
        x && x.setter && (b = "set " + b),
        (!t(m, "name") || (a && m.name !== b)) &&
          (i ? c(m, "name", { value: b, configurable: !0 }) : (m.name = b)),
        d && x && t(x, "arity") && m.length !== x.arity && c(m, "length", { value: x.arity }));
      try {
  ...
  var n = dr(),
    ...
    t = function (i) {
      return function (a, s, o) {
        ...
        } else for (; l > h; h++) if ((i || h in u) && u[h] === s) return i || h || 0;
        return !i && -1;
      };
    };
  ...
  return (
    (oi = function (o, u) {
      var l = o.target,
        ...
        p,
        y;
      if ((h ? (f = n) : c ? (f = n[l] || i(l, {})) : (f = n[l] && n[l].prototype), f))
        for (g in u) {
          if (
            ((p = u[g]),
...
function uh() {
  ...
  return (
    (pi = function (r, t, i) {
      return (
        i.get && n(i.get, t, { getter: !0 }), i.set && n(i.set, t, { setter: !0 }), e.f(r, t, i)
      );
    }),
    pi
  );
    ...
    (!v || !f) &&
      ...
      c
        ...
        : d && d.now
          ...
          : y && !h
            ? ((R = new y()), (P = R.port2), (R.port1.onmessage = I), (T = r(P.postMessage, P)))
            : n.addEventListener &&
                t(n.postMessage) &&
                !n.importScripts &&
                E &&
    ...
    f = t("Promise", function () {
      ...
      if (!u || u < 51 || !/native code/.test(g)) {
        var p = new e(function (b) {
          ...
          m = (p.constructor = {});
        if (((m[h] = y), (c = p.then(function () {}) instanceof y), !c)) return !0;
      }
  ...
  var n = fe(),
      ...
      try {
        W
          ? (H || (F.rejection === Ge && $e(F), (F.rejection = Ue)),
            W === !0 ? (Ee = z) : (Se && Se.enter(), (Ee = W(z)), Se && (Se.exit(), (hr = !0))),
            Ee === C.promise
    ...
    Ve = function (C, F, z) {
      ...
      (L
        ...
        !A && (W = t["on" + C]) ? W(H) : C === $ && y("Unhandled promise rejection", z));
    },
    Xe = function (C) {
      a(d, t, function () {
        var F = C.facade,
  ...
  return (
    (Wi = function (f, g, d) {
      ...
      if (m) E = f.iterator;
        ...
        if (i(T)) {
          for (R = 0, P = a(f); P > R; R++) if (((A = w(f[R])), A && s(v, A))) return A;
          return new c(!1);
        }
        E = o(f, T);
      }
  ...
  return (
    ...
    (ta =
      ...
      function (b, x) {
        var S;
        return (
          b !== null ? ((v[l] = n(b)), (S = new v()), (v[l] = null), (S[c] = b)) : (S = y()),
          x === void 0 ? S : e.f(S, x)
        );
      }),
    ta
...
function Lh() {
  ...
  var n = fe(),
    e = rn();
  return (n({ target: "RegExp", proto: !0, forced: /./.exec !== e }, { exec: e }), Po);
}
var sa, jo;
function tn() {
  if (jo) return sa;
      ...
      return function (l, h) {
        ...
        return v < 0 || v >= f
          ? u
            ...
            : void 0
          : ((g = a(c, v)),
            g < 55296 || g > 56319 || v + 1 === f || (d = a(c, v + 1)) < 56320 || d > 57343
              ? u
                ? i(c, v)
                : g
              : u
        ...
        return [
          ...
          function (N, j) {
            ...
            for (var Ge = "", ce = 0, Ne = 0; Ne < oe.length; Ne++) {
              ue = oe[Ne];
              for (
                var _e = h(ue[0]), be = b(x(u(ue.index), q.length), 0), ve = [], xe, De = 1;
                De < ue.length;
                De++
              )
                E(ve, P(ue[De]));
...
function Il() {
  ...
  var n = Z(),
    ...
    v;
  [].keys &&
    ((v = [].keys()), "next" in v ? ((c = i(i(v))), c !== Object.prototype && (h = c)) : (l = !0));
  var f =
    !r(h) ||
    n(function () {
      var g = {};
...
function uf() {
  ...
  if (!i || !a) {
    ...
    ((i = function (c) {
      ...
      (a = function (c) {
        for (var v = 0; v < l.length; v++) l[v].handle === c && (l[v].cancelled = !0);
      }));
  }
  return (
        ...
        ((this.r = this.r < 0 || isNaN(this.r) ? 0 : this.r > 255 ? 255 : this.r),
          ...
          (this.getHelpXML = function () {
            for (var u = new Array(), l = 0; l < r.length; l++)
              for (var h = r[l].example, c = 0; c < h.length; c++) u[u.length] = h[c];
...
function bf(n) {
  ...
  for (var r = 0; r < n.length; r++) {
    ...
    if (t.type === O.CLOSE_PATH) e += "z";
      ...
      if (t.type !== O.ARC)
        throw new Error('Unexpected command type "' + t.type + '" at index ' + r + ".");
      e +=
        (t.relative ? "a" : "A") +
        t.rX +
        " " +
...
function Ce() {
  ...
  for (var r = 0; r < n.length; r++)
    if (typeof n[r] != "number")
      throw new Error(
        "assertNumbers arguments[" + r + "] is not a number. " + typeof n[r] + " == typeof " + n[r],
      );
  return !0;
}
var ze = Math.PI;
  ...
  function r() {
    ...
    return i(function (c, v, f) {
      return (
        ...
        c.type & O.CURVE_TO
          ? ((o = c.relative ? v + c.x2 : c.x2), (u = c.relative ? f + c.y2 : c.y2))
          : ((o = NaN), (u = NaN)),
        ...
        c.type & O.QUAD_TO
          ? ((l = c.relative ? v + c.x1 : c.x1), (h = c.relative ? f + c.y1 : c.y1))
          : ((l = NaN), (h = NaN)),
        c
      );
    });
  ...
  function a(o, u, l, h, c, v) {
    return (
      ...
      i(function (f, g, d, p) {
        ...
        (f.type & O.HORIZ_LINE_TO && u !== 0 && ((f.type = O.LINE_TO), (f.y = f.relative ? 0 : d)),
          f.type & O.VERT_LINE_TO && l !== 0 && ((f.type = O.LINE_TO), (f.x = f.relative ? 0 : g)),
    ...
    (n.NORMALIZE_HVZ = function (o, u, l) {
      return (
        ...
        i(function (h, c, v, f, g) {
          ...
          return (
            u && h.type & O.HORIZ_LINE_TO && ((h.type = O.LINE_TO), (h.y = h.relative ? 0 : v)),
            l && h.type & O.VERT_LINE_TO && ((h.type = O.LINE_TO), (h.x = h.relative ? 0 : c)),
            o &&
              h.type & O.CLOSE_PATH &&
              ((h.type = O.LINE_TO),
    ...
    (n.SANITIZE = function (o) {
      ...
      return i(function (v, f, g, d, p) {
        var y = Math.abs,
          ...
          x = 0;
        if (
          (v.type & O.SMOOTH_CURVE_TO && ((b = isNaN(u) ? 0 : f - u), (x = isNaN(l) ? 0 : g - l)),
          v.type & (O.CURVE_TO | O.SMOOTH_CURVE_TO)
            ? ((u = v.relative ? f + v.x2 : v.x2), (l = v.relative ? g + v.y2 : v.y2))
            : ((u = NaN), (l = NaN)),
          v.type & O.SMOOTH_QUAD_TO
            ? ((h = isNaN(h) ? f : 2 * f - h), (c = isNaN(c) ? g : 2 * g - c))
            : v.type & O.QUAD_TO
              ? ((h = v.relative ? f + v.x1 : v.x1), (c = v.relative ? g + v.y1 : v.y2))
              : ((h = NaN), (c = NaN)),
          ...
          ((b = isNaN(h) ? (v.x1 === void 0 ? b : v.relative ? v.x : v.x1 - f) : h - f),
            (x = isNaN(c) ? (v.y1 === void 0 ? x : v.relative ? v.y : v.y1 - g) : c - g));
                      ...
                      if (this.curArgs.length === 0 || this.curArgs.length === 1) {
                        if (0 > h)
                          throw new SyntaxError(
                            'Expected positive number, got "' + h + '" at index "' + s + '"',
                          );
                      } else if (
                        (this.curArgs.length === 3 || this.curArgs.length === 4) &&
                        this.curNumber !== "0" &&
                        ...
                        throw new SyntaxError(
                          'Expected a flag, got "' + this.curNumber + '" at index "' + s + '"',
                        );
                    }
                    (this.curArgs.push(h),
                      this.curArgs.length === Tf[this.curCommandType] &&
                        (O.HORIZ_LINE_TO === this.curCommandType
                          ? a({ type: O.HORIZ_LINE_TO, relative: this.curCommandRelative, x: h })
                          : O.VERT_LINE_TO === this.curCommandType
                            ? a({ type: O.VERT_LINE_TO, relative: this.curCommandRelative, y: h })
                    ...
                    if (o === "," && this.canParseCommandOrComma) this.canParseCommandOrComma = !1;
                      ...
                      if (l) ((this.curNumber = o), (this.curNumberHasDecimal = !1));
                        ...
                        if (this.curArgs.length !== 0)
                          throw new SyntaxError("Unterminated command at index " + s + ".");
                        ...
                        if (((this.canParseCommandOrComma = !1), o !== "z" && o !== "Z"))
                          if (o === "h" || o === "H")
                            ...
                            if (o !== "a" && o !== "A")
                              throw new SyntaxError(
                                'Unexpected character "' + o + '" at index ' + s + ".",
                              );
...
function Af(n, e, r, t, i, a) {
  ...
  for (var $e = 0; $e < t; $e++) {
    ...
    var ge = s[b],
      ...
      Ee = c * C;
    f = v;
    for (var lr = 0; lr < h; lr++) ((f.r = ge), (f.g = de), (f.b = Oe), (f.a = C), (f = f.next));
...
function If() {
  var { DOMParser: n } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
    e = {
      window: null,
      ignoreAnimation: !0,
      ignoreMouse: !0,
...
var $c = Object.freeze({ __proto__: null, offscreen: If, node: Nf });
function or(n) {
...
function Vf(n) {
  ...
  var e = 3,
    r = n.replace(/\d+(\.\d+)?/g, (t, i) => (e-- && i ? String(Math.round(parseFloat(t))) : t));
  return r;
}
var Lf = /(\[[^\]]+\])/g,
  kf = /(#[^\s+>~.[:]+)/g,
...
class M {
  ...
  getColor(e) {
    ...
    return (
      this.isNormalizedColor || ((this.isNormalizedColor = !0), (r = Vf(r)), (this.value = r)), r
    );
  }
  getDpi() {
    return 96;
  ...
  getFillStyleDefinition(e, r) {
    ...
    if (!t) return null;
    if (typeof t.createGradient == "function") return t.createGradient(this.document.ctx, e, r);
    if (typeof t.createPattern == "function") {
      if (t.getHrefAttribute().hasValue()) {
        ...
        ((t = t.getHrefAttribute().getDefinition()),
          i.hasValue() && t.getAttribute("patternTransform", !0).setValue(i.value));
      }
...
class ee {
  ...
  static parsePath(e) {
    for (var r = me(e), t = r.length, i = [], a = 0; a < t; a += 2) i.push(new ee(r[a], r[a + 1]));
    return i;
  }
  angleTo(e) {
...
class Hf {
  ...
  mapXY(e, r) {
    for (var { window: t, ctx: i } = this.screen, a = new ee(e, r), s = i.canvas; s; )
...
class $r {
  ...
  isReady() {
    ...
    return (
      e && ((this.waits = []), this.resolveReady && this.resolveReady()), (this.isReadyLock = e), e
    );
  }
  setDefaults(e) {
      ...
      var d = Date.now(),
        ...
        m = () => {
          ((d = Date.now()),
            ...
            y >= g &&
              ((p = d - (y % g)),
              this.shouldUpdate(i, o) && (this.render(e, a, s, u, l, h, c), f.runEvents())),
  ...
  render(e, r, t, i, a, s, o) {
    var { CLIENT_WIDTH: u, CLIENT_HEIGHT: l, viewPort: h, ctx: c, isFirstRender: v } = this,
      f = c.canvas;
    ...
    !r &&
      ...
      (g.hasValue() &&
        ((f.width = g.getPixels("x")), f.style && (f.style.width = "".concat(f.width, "px"))),
      d.hasValue() &&
        ((f.height = d.getPixels("y")), f.style && (f.style.height = "".concat(f.height, "px"))));
    var p = f.clientWidth || f.width,
      y = f.clientHeight || f.height;
    if (
      (r && g.hasValue() && d.hasValue() && ((p = g.getPixels("x")), (y = d.getPixels("y"))),
      h.setCurrent(p, y),
...
class Kf {
  ...
  applyToPoint(e) {
    var { cx: r, cy: t, angle: i } = this,
      a = i.getRadians();
    (e.applyTransform([1, 0, 0, 1, r || 0, t || 0]),
      e.applyTransform([Math.cos(a), Math.sin(a), -Math.sin(a), Math.cos(a), 0, 0]),
      e.applyTransform([1, 0, 0, 1, -r || 0, -t || 0]));
  }
}
class Qf {
...
class Je {
  ...
  apply(e) {
    for (var { transforms: r } = this, t = r.length, i = 0; i < t; i++) r[i].apply(e);
  }
  unapply(e) {
    for (var { transforms: r } = this, t = r.length, i = t - 1; i >= 0; i--) r[i].unapply(e);
  }
  applyToPoint(e) {
    for (var { transforms: r } = this, t = r.length, i = 0; i < t; i++) r[i].applyToPoint(e);
  }
}
Je.transformTypes = { translate: Xf, rotate: Kf, scale: Qf, matrix: Bl, skewX: Zf, skewY: Jf };
class K {
  constructor(e, r) {
      ...
      if (!t.startsWith("@") && this.matchesSelector(t)) {
        ...
        if (i)
          for (var s in i) {
            ...
            (typeof o > "u" && (o = "000"),
              a >= o && ((this.styles[s] = i[s]), (this.stylesSpecificity[s] = a)));
          }
      }
  }
  removeStyles(e, r) {
...
class Ie {
  constructor() {
    var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Number.NaN,
      r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Number.NaN,
      t = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : Number.NaN,
  ...
  bezierCurveAdd(e, r, t, i, a) {
    ...
    if (o === 0) {
      ...
      0 < l &&
        l < 1 &&
        (e ? this.addX(this.sumCubic(l, r, t, i, a)) : this.addY(this.sumCubic(l, r, t, i, a)));
      return;
    }
    ...
    if (!(h < 0)) {
      ...
      0 < c &&
        c < 1 &&
        (e ? this.addX(this.sumCubic(c, r, t, i, a)) : this.addY(this.sumCubic(c, r, t, i, a)));
      var v = (-s - Math.sqrt(h)) / (2 * o);
      0 < v &&
        v < 1 &&
        (e ? this.addX(this.sumCubic(v, r, t, i, a)) : this.addY(this.sumCubic(v, r, t, i, a)));
    }
  }
...
class G extends O {
  ...
  addMarker(e, r, t) {
    ...
    (t && a.length > 0 && !a[a.length - 1] && (a[a.length - 1] = i[i.length - 1].angleTo(t)),
  ...
  setContext(e) {
      ...
      if (
        ...
        typeof e.setLineDash < "u"
          ...
          : typeof e.webkitLineDash < "u"
            ? (e.webkitLineDash = x)
            : typeof e.mozDash < "u" && !(x.length === 1 && x[0] === 0) && (e.mozDash = x);
        var S = b.getPixels();
    ...
    if (((this.modifiedEmSizeStack = !1), typeof e.font < "u")) {
      ...
      (T.setValue(I.fontStyle),
        ...
        (e.font = I.toString()),
        A.isPixels() && ((this.document.emSize = A.getPixels()), (this.modifiedEmSizeStack = !0)));
    }
...
class Y extends ir {
  ...
  static pathA(e) {
    ...
    var f =
      ...
      Math.sqrt(
        (Math.pow(i, 2) * Math.pow(a, 2) -
          ...
          (Math.pow(i, 2) * Math.pow(c.y, 2) + Math.pow(a, 2) * Math.pow(c.x, 2)),
      );
    isNaN(f) && (f = 0);
    ...
    return (
      Ba(y, m) <= -1 && (b = Math.PI),
      Ba(y, m) >= 1 && (b = 0),
      { currentPoint: h, rX: i, rY: a, sweepFlag: u, xAxisRotation: l, centp: d, a1: p, ad: b }
    );
  }
  pathA(e, r) {
    var { pathParser: t } = this,
...
class We extends ir {
  ...
  adjustChildCoordinates(e, r, t, i) {
    ...
    return (
      c && (r.x -= v),
      s.hasValue()
        ? (r.applyAnchoring(), (a.x = s.getPixels("x")), u.hasValue() && (a.x += u.getPixels("x")))
...
class Tr extends ir {
  ...
  setContext(e) {
    var r,
      ...
      s = e.canvas;
    if (
      (i.setDefaults(e), s.style && typeof e.font < "u" && a && typeof a.getComputedStyle < "u")
    ) {
    ...
    (f && ((d = f[0]), (p = f[1])),
      ...
      this.node &&
        (!this.parent ||
          ((r = this.node.parentNode) === null || r === void 0 ? void 0 : r.nodeName) ===
            "foreignObject") &&
  ...
  resize(e) {
    var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : e,
      ...
      l = a.getNumber(0);
    if (t)
      if (typeof t == "string") this.getAttribute("preserveAspectRatio", !0).setValue(t);
      else {
    ...
    if (
      ...
      (e.beginPath(),
        a > 0 &&
          ...
          (e.moveTo(r + u, t),
          e.lineTo(r + i - u, t),
          e.bezierCurveTo(r + i - u + h * u, t, r + i, t + l - h * l, r + i, t + l),
          e.lineTo(r + i, t + a - l),
          e.bezierCurveTo(r + i, t + a - l + h * l, r + i - u + h * u, t + a, r + i - u, t + a),
          e.lineTo(r + u, t + a),
          e.bezierCurveTo(r + u - h * u, t + a, r, t + a - l + h * l, r, t + a - l),
          e.lineTo(r, t + l),
...
class uc extends Y {
  ...
  path(e) {
    ...
    return (
      e && i > 0 && (e.beginPath(), e.arc(r, t, i, 0, Math.PI * 2, !1), e.closePath()),
...
class hc extends Y {
  ...
  getPoints() {
    return [
      new ee(this.getAttribute("x1").getPixels("x"), this.getAttribute("y1").getPixels("y")),
      new ee(this.getAttribute("x2").getPixels("x"), this.getAttribute("y2").getPixels("y")),
    ];
  }
  path(e) {
  ...
  render(e, r, t) {
    if (r) {
      ...
      ((u.type = this.type),
        ...
        (u.attributes.refX = new M(this.document, "refX", this.getAttribute("refX").getValue())),
        (u.attributes.refY = new M(this.document, "refY", this.getAttribute("refY").getValue())),
...
class hn extends K {
  ...
  update(e) {
    ...
    if (
      (this.initialValue ||
        ((this.initialValue = t.getString()), (this.initialUnits = t.getUnits())),
      ...
      if (
        ...
        return (
          (this.removed = !0),
          t.setValue(r.animationFrozen ? r.animationFrozenValue : this.initialValue),
          !0
        );
      return !1;
    }
  ...
  getProgress() {
    var { document: e, values: r } = this,
      t = { progress: (this.duration - this.begin) / (this.maxDuration - this.begin) };
    if (r.hasValue()) {
      ...
      switch (s.type) {
        ...
        case "glyph": {
          ...
          u.arabicForm
            ? ((this.isRTL = !0),
              (this.isArabic = !0),
              typeof this.glyphs[u.unicode] > "u" && (this.glyphs[u.unicode] = Object.create(null)),
...
class Ec extends We {
  ...
  renderChildren(e) {
    if (this.hasText) {
      ...
      a.isWorking() &&
        a.checkBoundingBox(this, new Ie(t, i - s.getPixels("y"), t + this.measureText(e), i));
...
class Rc extends We {
    ...
    (r === "underline" && e.beginPath(),
      i.forEach((s, o) => {
        ...
        (e.save(),
          ...
          e.restore(),
          r === "underline" && (o === 0 && e.moveTo(u.x, u.y + t / 8), e.lineTo(l.x, l.y + t / 5)));
      }),
      r === "underline" && ((e.lineWidth = t / 20), (e.strokeStyle = a), e.stroke(), e.closePath()),
      e.restore());
  }
  getLetterSpacingAt() {
    ...
    if (!this.glyphInfo) {
      ...
      ((o === "middle" || o === "center") && (b = -p / 2),
        ...
        t.forEach((x, S) => {
          ...
          ((b = E),
            !(!T.p0 || !T.p1) &&
              this.glyphInfo.push({ text: t[S], p0: T.p0, p1: T.p1, rotation: R }));
        }));
    }
  }
  parsePathData(e) {
  ...
  pathA(e) {
    var { rX: r, rY: t, sweepFlag: i, xAxisRotation: a, centp: s, a1: o, ad: u } = Y.pathA(e);
    return (
      i === 0 && u > 0 && (u -= 2 * Math.PI),
      i === 1 && u < 0 && (u += 2 * Math.PI),
      [s.x, s.y, r, t, o, u, a, i]
  ...
  calcLength(e, r, t, i) {
    ...
    switch (t) {
      ...
      case G.CURVE_TO:
        for (
          a = 0,
            s = this.getPointOnCubicBezier(0, e, r, i[0], i[1], i[2], i[3], i[4], i[5]),
            u = 0.01;
          u <= 1;
          u += 0.01
        )
          ((o = this.getPointOnCubicBezier(u, e, r, i[0], i[1], i[2], i[3], i[4], i[5])),
            (a += this.getLineLength(s.x, s.y, o.x, o.y)),
            (s = o));
        return a;
      case G.QUAD_TO:
        for (
          a = 0, s = this.getPointOnQuadraticBezier(0, e, r, i[0], i[1], i[2], i[3]), u = 0.01;
          u <= 1;
          u += 0.01
        )
          ((o = this.getPointOnQuadraticBezier(u, e, r, i[0], i[1], i[2], i[3])),
            (a += this.getLineLength(s.x, s.y, o.x, o.y)),
            (s = o));
        return a;
      case G.ARC: {
      ...
      switch (s.type) {
        ...
        case G.ARC: {
          var l = s.points[4],
            h = s.points[5],
            c = s.points[4] + h;
          if (((u = l + (o / s.pathLength) * h), (h < 0 && u < c) || (h >= 0 && u > c))) break;
    ...
    if (
      ...
      for (var s = 0, o = 0; o <= t; o += i) {
        ...
        !u ||
          ...
          s >= a && (this.equidistantCache.points.push({ x: u.x, y: u.y, distance: o }), (s -= a)));
      }
    }
  }
  getEquidistantPointOnPath(e, r, t) {
    if ((this.buildEquidistantCache(r, t), e < 0 || e - this.getPathLength() > 5e-5)) return null;
  ...
  renderChildren(e) {
    ...
    if (t) {
      ...
      if (
        (t.type === "symbol" &&
          ((i = new Tr(r, null)),
          (i.attributes.viewBox = new M(r, "viewBox", t.getAttribute("viewBox").getString())),
          (i.attributes.preserveAspectRatio = new M(
            r,
            "preserveAspectRatio",
            t.getAttribute("preserveAspectRatio").getString(),
          )),
          (i.attributes.overflow = new M(r, "overflow", t.getAttribute("overflow").getString())),
        ...
        (a.hasValue() && (i.attributes.width = new M(r, "width", a.getString())),
          s.hasValue() && (i.attributes.height = new M(r, "height", s.getString())));
      }
      var o = i.parent;
...
class Wl extends K {
  ...
  apply(e, r, t, i, a) {
    for (
      var { includeOpacity: s, matrix: o } = this, u = e.getImageData(0, 0, i, a), l = 0;
      l < a;
      l++
    )
      for (var h = 0; h < i; h++) {
        var c = Cr(u.data, h, l, i, a, 0),
          ...
          d = te(o, 0, c) + te(o, 1, v) + te(o, 2, f) + te(o, 3, g) + te(o, 4, 1),
          p = te(o, 5, c) + te(o, 6, v) + te(o, 7, f) + te(o, 8, g) + te(o, 9, 1),
          y = te(o, 10, c) + te(o, 11, v) + te(o, 12, f) + te(o, 13, g) + te(o, 14, 1),
          m = te(o, 15, c) + te(o, 16, v) + te(o, 17, f) + te(o, 18, g) + te(o, 19, 1);
...
class gr {
  ...
  render() {
    ...
    return Be(function* () {
      ...
      (r.start(Qe({ enableRedraw: !0, ignoreAnimation: !0, ignoreMouse: !0 }, t)),
        yield r.ready(),
        r.stop());
    })();
  }
